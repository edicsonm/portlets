...
<aui:form method="post">
	<div class="table">
		<div class="section">
			...
			<div class="row">
				<div class="column3-4">
					<label class="aui-field-label"><fmt:message key="label.passwordKeyStore"/></label>
				</div>
				<div class="column4-4">
					<c:out value="${merchantConfigurationVO.passwordKeyStore}"/>
				</div>
				<div class="column3-4">
					<label class="aui-field-label"><fmt:message key="label.privacyKeyStore"/></label>
				</div>
				<div class="column4-4">
					<c:out value="${merchantConfigurationVO.privacyKeyStore}"/>
				</div>
			</div>
			
			<div class="row">
				<div class="column3-4">
					<label class="aui-field-label"><fmt:message key="label.passwordkey"/></label>
				</div>
				<div class="column4-4">
					<c:out value="${merchantConfigurationVO.passwordkey}"/>
				</div>
				<div class="column3-4">
					<label class="aui-field-label"><fmt:message key="label.keyName"/></label>
				</div>
				<div class="column4-4">
					<c:out value="${merchantConfigurationVO.keyName}"/>
				</div>
			</div>
