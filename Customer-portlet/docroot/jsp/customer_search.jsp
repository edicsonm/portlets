...
%>
<liferay-ui:search-toggle buttonLabel="Buscar..." displayTerms="<%= displayTerms %>" id="toggle_id_customer_search">
	
	<aui:input label="label.email" id="email" name="email" value="<%=email %>"/>
