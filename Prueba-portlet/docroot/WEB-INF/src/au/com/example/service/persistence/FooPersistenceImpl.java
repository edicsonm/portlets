...
import au.com.example.NoSuchFooException;
import au.com.example.model.Foo;
import au.com.example.model.impl.FooImpl;
import au.com.example.model.impl.FooModelImpl;
...
public class FooPersistenceImpl extends BasePersistenceImpl<Foo>
	...
	@Override
	public Foo updateImpl(au.com.example.model.Foo foo)
		throws SystemException {
		foo = toUnwrappedModel(foo);
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.au.com.example.model.Foo")));
