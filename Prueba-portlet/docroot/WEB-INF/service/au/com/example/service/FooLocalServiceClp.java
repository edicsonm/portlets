...
public class FooLocalServiceClp implements FooLocalService {
	...
	public au.com.example.model.Foo addFoo(au.com.example.model.Foo foo)
		...
		return (au.com.example.model.Foo)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<au.com.example.model.Foo> getFoos(int start, int end)
		...
		return (java.util.List<au.com.example.model.Foo>)ClpSerializer.translateOutput(returnObj);
	}
