...
public class FooUtil {
	...
	*/
	public static java.util.List<au.com.example.model.Foo> findByField2(
		boolean field2)
	...
	* @throws au.com.example.NoSuchFooException if a matching foo could not be found
	* @throws SystemException if a system exception occurred
	*/
	public static au.com.example.model.Foo findByField2_First(boolean field2,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws au.com.example.NoSuchFooException,
	...
	* @throws SystemException if a system exception occurred
	*/
	public static au.com.example.model.Foo fetchByField2_First(boolean field2,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static au.com.example.model.Foo findByField2_Last(boolean field2,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws au.com.example.NoSuchFooException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static au.com.example.model.Foo fetchByField2_Last(boolean field2,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws au.com.example.NoSuchFooException if a foo with the primary key could not be found
	* @throws SystemException if a system exception occurred
	*/
	public static au.com.example.model.Foo[] findByField2_PrevAndNext(
	...
	* @param foo the foo
	*/
	public static void cacheResult(au.com.example.model.Foo foo) {
	...
	*/
	public static void cacheResult(
		java.util.List<au.com.example.model.Foo> foos) {
	...
	* @return the new foo
	*/
	public static au.com.example.model.Foo create(long fooId) {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static au.com.example.model.Foo remove(long fooId)
		throws au.com.example.NoSuchFooException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().remove(fooId);
	}

	public static au.com.example.model.Foo updateImpl(
		au.com.example.model.Foo foo)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(foo);
	}

	/**
	* Returns the foo with the primary key or throws a {@link au.com.example.NoSuchFooException} if it could not be found.
	*
	* @param fooId the primary key of the foo
	* @return the foo
	* @throws au.com.example.NoSuchFooException if a foo with the primary key could not be found
	* @throws SystemException if a system exception occurred
	*/
	public static au.com.example.model.Foo findByPrimaryKey(long fooId)
		throws au.com.example.NoSuchFooException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static au.com.example.model.Foo fetchByPrimaryKey(long fooId)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<au.com.example.model.Foo> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<au.com.example.model.Foo> findAll(int start,
	...
	*/
	...
	public static FooPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (FooPersistence)PortletBeanLocatorUtil.locate(au.com.example.service.ClpSerializer.getServletContextName(),
