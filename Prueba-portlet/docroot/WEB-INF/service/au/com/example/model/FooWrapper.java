...
public class FooWrapper implements Foo, ModelWrapper<Foo> {
	...
	*/
	...
	@Override
	public int compareTo(au.com.example.model.Foo foo) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<au.com.example.model.Foo> toCacheModel() {
		return _foo.toCacheModel();
	}

	@Override
	public au.com.example.model.Foo toEscapedModel() {
		return new FooWrapper(_foo.toEscapedModel());
	}

	@Override
	public au.com.example.model.Foo toUnescapedModel() {
