...
public class FooUtil {
	...
	*/
	public static java.util.List<ve.com.ed.model.Foo> findByField2(
		boolean field2)
	...
	* @throws ve.com.ed.NoSuchFooException if a matching foo could not be found
	* @throws SystemException if a system exception occurred
	*/
	public static ve.com.ed.model.Foo findByField2_First(boolean field2,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException,
			ve.com.ed.NoSuchFooException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static ve.com.ed.model.Foo fetchByField2_First(boolean field2,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static ve.com.ed.model.Foo findByField2_Last(boolean field2,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException,
			ve.com.ed.NoSuchFooException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static ve.com.ed.model.Foo fetchByField2_Last(boolean field2,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws ve.com.ed.NoSuchFooException if a foo with the primary key could not be found
	* @throws SystemException if a system exception occurred
	*/
	public static ve.com.ed.model.Foo[] findByField2_PrevAndNext(long fooId,
		boolean field2,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException,
			ve.com.ed.NoSuchFooException {
	...
	* @param foo the foo
	*/
	public static void cacheResult(ve.com.ed.model.Foo foo) {
	...
	* @param foos the foos
	*/
	public static void cacheResult(java.util.List<ve.com.ed.model.Foo> foos) {
	...
	* @return the new foo
	*/
	public static ve.com.ed.model.Foo create(long fooId) {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static ve.com.ed.model.Foo remove(long fooId)
		throws com.liferay.portal.kernel.exception.SystemException,
			ve.com.ed.NoSuchFooException {
		return getPersistence().remove(fooId);
	}

	public static ve.com.ed.model.Foo updateImpl(ve.com.ed.model.Foo foo)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(foo);
	}

	/**
	* Returns the foo with the primary key or throws a {@link ve.com.ed.NoSuchFooException} if it could not be found.
	*
	* @param fooId the primary key of the foo
	* @return the foo
	* @throws ve.com.ed.NoSuchFooException if a foo with the primary key could not be found
	* @throws SystemException if a system exception occurred
	*/
	public static ve.com.ed.model.Foo findByPrimaryKey(long fooId)
		throws com.liferay.portal.kernel.exception.SystemException,
			ve.com.ed.NoSuchFooException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static ve.com.ed.model.Foo fetchByPrimaryKey(long fooId)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<ve.com.ed.model.Foo> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<ve.com.ed.model.Foo> findAll(int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<ve.com.ed.model.Foo> findAll(int start,
		int end,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static FooPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (FooPersistence)PortletBeanLocatorUtil.locate(ve.com.ed.service.ClpSerializer.getServletContextName(),
