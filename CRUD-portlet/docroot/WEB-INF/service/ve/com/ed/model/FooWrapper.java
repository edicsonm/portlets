...
public class FooWrapper implements Foo, ModelWrapper<Foo> {
	...
	*/
	...
	@Override
	public int compareTo(ve.com.ed.model.Foo foo) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<ve.com.ed.model.Foo> toCacheModel() {
		return _foo.toCacheModel();
	}

	@Override
	public ve.com.ed.model.Foo toEscapedModel() {
		return new FooWrapper(_foo.toEscapedModel());
	}

	@Override
	public ve.com.ed.model.Foo toUnescapedModel() {
