...
import ve.com.ed.NoSuchFooException;
import ve.com.ed.model.Foo;
import ve.com.ed.model.impl.FooImpl;
import ve.com.ed.model.impl.FooModelImpl;
...
public class FooPersistenceImpl extends BasePersistenceImpl<Foo>
	...
	@Override
	public Foo updateImpl(ve.com.ed.model.Foo foo) throws SystemException {
		foo = toUnwrappedModel(foo);
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.ve.com.ed.model.Foo")));
